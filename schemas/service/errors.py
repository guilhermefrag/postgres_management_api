...
def schema_error_handling(schema_name, database_name):
    ...
    if check_existent_schema(schema_name, database_name):
        raise ValidationError("Schema already exists.")

def check_existent_schema(schema_name: str, database_name) -> bool:
